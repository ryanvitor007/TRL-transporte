        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-sidebar-foreground">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <Image src="/images/image.png" alt="TRL Transporte" width={56} height={56} className="rounded-lg" />
              <div>
                <h1 className="text-2xl font-bold">TRL Transporte</h1>
                <p className="text-sm text-sidebar-foreground/70">Sistema de Gestão de Frota</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-sidebar-foreground/80 max-w-md text-pretty">
              Monitoramento em tempo real, controle de documentos, manutenções preventivas e muito mais em uma única
              plataforma.
            </p>
            ...
            <div className="space-y-4 pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-sidebar-foreground/70">Controle todos os veículos em um só lugar</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-sidebar-primary/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-sidebar-foreground/70">Alertas de vencimento automáticos</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-sidebar-primary/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-sidebar-foreground/70">TCO e relatórios financeiros detalhados</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Footer */}
          <div className="text-sm text-sidebar-foreground/60">© 2026 TRL Transporte. Todos os direitos reservados.</div>
        </div>
      </div>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center bg-background p-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="flex lg:hidden items-center justify-center gap-3 mb-8">
            <Image src="/images/image.png" alt="TRL Transporte" width={48} height={48} className="rounded-lg" />
            <span className="text-xl font-bold text-foreground">TRL Transporte</span>
          </div>

          {/* Header */}
          <div className="text-center lg:text-left">
            <h2 className="text-3xl font-bold text-foreground">Bem-vindo de volta</h2>
            <p className="mt-2 text-muted-foreground">Por favor, faça login em sua conta</p>
          </div>
