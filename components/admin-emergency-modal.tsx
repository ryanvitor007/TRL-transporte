              ...
              <div className="rounded-lg border border-red-200 bg-white p-4">
                ...
                {journey.checklistNotes && (
                  <div className="mt-3 rounded-md bg-amber-50 p-3 text-sm">
                    ...
                    <p className="mt-1 text-amber-700">{journey.checklistNotes}</p>
                  </div>
                )}
              </div>
            )}
        ...
        <DialogFooter className="flex-col gap-2 sm:flex-row">
          ...
          >
            {isBlocking ? (
              ...
              <>
                ...
                {showConfirmBlock ? "Confirmar Bloqueio" : "Bloquear e Solicitar Manutencao"}
              </>
            )}
          </Button>
          ...
          <Button
            ...
            className={cn(
              ...
              showConfirmAuthorize && "border-green-300 bg-green-50 text-green-700 hover:bg-green-100"
            )}
          ...
          >
            {isAuthorizing ? (
              ...
              <>
                ...
                {showConfirmAuthorize ? "Confirmar Autorizacao" : "Autorizar Viagem com Risco"}
              </>
            )}
          </Button>
        </DialogFooter>
