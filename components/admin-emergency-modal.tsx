...
const checklistLabels: Record<string, { label: string; severity: "high" | "medium" }> = {
              ...
              <div className="p-3 space-y-2">
                {hasRejectedItems ? (
                  ...
                  <div className="text-center py-4 text-muted-foreground">
                    ...
                    <p className="text-sm">Checklist reprovado sem itens especificos</p>
                  </div>
                )}
              </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="mt-1 text-amber-700">
                      Esta acao sera registrada e o motorista podera iniciar a viagem
                      mesmo com itens reprovados.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <DialogFooter className="flex-col gap-3 sm:flex-row pt-2">
          ...
          >
            {isBlocking ? (
              ...
              <>
                {showConfirmBlock ? <Ban className="h-4 w-4" /> : <Wrench className="h-4 w-4" />}
                {showConfirmBlock ? "CONFIRMAR BLOQUEIO" : "Bloquear + Manutencao"}
              </>
            )}
          </Button>
          ...
          >
            {isAuthorizing ? (
              ...
              <>
                {showConfirmAuthorize ? <ShieldCheck className="h-4 w-4" /> : <CheckCircle2 className="h-4 w-4" />}
                {showConfirmAuthorize ? "CONFIRMAR LIBERACAO" : "Autorizar com Risco"}
              </>
            )}
          </Button>
        </DialogFooter>
